...
- 기각 사유: 사용자 1명인 로컬 도구에 학습 시스템은 과잉. "demo-site 우선순위 높게 봄" → 핀 기능으로 해결. "Opus 비용 신경 씀" → 예산 설정으로 해결. 설정 JSON으로 되는 걸 LLM 메모리로 풀 이유 없음.
