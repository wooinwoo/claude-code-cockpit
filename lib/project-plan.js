...
const AGENTS = {
  ...
  mid: { id: 'dev_daeri', name: '핏대리', emoji: '🔥', provider: 'gemini', model: 'gemini-2.5-pro' },  // Pro for quality
  junior: { id: 'dev_sawon', name: '콕사원', emoji: '🐣', provider: 'gemini', model: 'gemini-2.5-pro' }, // Pro for quality
};
