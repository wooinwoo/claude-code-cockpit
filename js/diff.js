...
import { esc, showToast, DIFF_LINE_LIMIT, fetchJson, postJson, simpleMarkdown, captureScroll } from './utils.js';
...
export async function loadDiff() {
  ...
  const restoreScroll = captureScroll(mainEl);
  if (!mainEl.querySelector('#diff-panels-inner')) {
